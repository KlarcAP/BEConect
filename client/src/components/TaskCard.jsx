      ...
      <div className='w-full h-fit bg-white dark:bg-gray-800 shadow-md p-4 rounded'>
        <div className='w-full flex justify-between'>
          ...
          >
            ...
            <span className='uppercase'>Prioridade {task?.priority}</span>
          </div>
        ...
        {task?.subTasks?.length > 0 ? (
          <div className='py-4 border-t border-gray-200 dark:border-gray-600'>
            ...
            <div className='p-4 space-x-8'>
              ...
              <span className='bg-purple-500/10 px-3 py-1 rounded0full text-blue-700 font-medium'>
                {task?.subTasks[0].tag}
              </span>
            </div>
          </div>
          ...
          <>
            <div className='py-4 border-t border-gray-200 '>
              <span className='text-gray-500 dark:text-white'>Sem Anexo</span>
            </div>
          </>
        )}
        ...
        <div className='w-full pb-2'>
          <button
            ...
            className='w-full flex gap-4 items-center text-sm text-gray-500 dark:text-white font-semibold disabled:cursor-not-allowed disabled::text-gray-300'
          >
