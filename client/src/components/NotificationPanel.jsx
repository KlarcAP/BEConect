...
const data = [
  {
    ...
    text: "Uma nova tarefa foi atribuída a você e mais 2 pessoas. A prioridade da tarefa está definida como uma prioridade normal, portanto verifique e aja de acordo. Obrigado!!!",
    task: null,
    notiType: "alert",
    isRead: [],
  ...
  },
  {
    ...
    text: "Uma nova tarefa foi atribuída a você e mais 2 pessoas. A prioridade da tarefa está definida como uma prioridade high, portanto verifique e aja de acordo. Obrigado!!!",
    task: {
