...
const TABS = [
  { title: "Detalhes do Projeto", icon: <FaTasks /> },
  { title: "Atividades/Linha do Tempo", icon: <RxActivityLog /> },
];
  ...
  return (
    <div className='w-full flex flex-col gap-3 mb-4 overflow-y-hidden'>
      ...
      <Tabs tabs={TABS} setSelected={setSelected}>
        {selected === 0 ? (
          <>
            <div className='w-full flex flex-col md:flex-row gap-5 2xl:gap-8 bg-white dark:bg-gray-800 shadow-md p-8 overflow-y-auto'>
              {/* LEFT */}
              <div className='w-full md:w-1/2 space-y-8'>
                <div className='flex items-center gap-5'>
                  ...
                  >
                    ...
                    <span className='uppercase dark:text-white'>{task?.priority} Prioridade</span>
                  </div>
                ...
                <p className='text-gray-500'>
                  Criado Em: {new Date(task?.date).toDateString()}
                </p>

                <div className='flex items-center gap-8 p-4 border-y border-gray-200'>
                  <div className='space-x-2'>
                    <span className='font-semibold dark:text-white'>Anexos :</span>
                  ...
                  <div className='space-y-3'>
                    {task?.team?.map((m, index) => (
                      ...
                      >
                        <div
                          className={
                            "w-10 h-10 rounded-full text-white flex items-center justify-center text-sm -mr-1 bg-purple-500"
                          }
                        >
      ...
      <div className='w-full md:w-1/3'>
        ...
        <div className='w-full flex flex-wrap gap-5'>
          ...
          <textarea
            ...
            placeholder='Texto...'
            className='bg-white dark:bg-gray-800 w-full mt-10 border border-gray-300 outline-none p-4 rounded-md focus:ring-2 ring-blue-500'
          ></textarea>
          {isLoading ? (
            <Loading />
          ) : (
