  ...
  const TableHeader = () => (
    <thead className='border-b border-gray-300 dark:border-gray-600  '>
      <tr className='text-black dark:text-white text-left'>
        <th className='py-2'>Título Projeto</th>
...
const UserTable = ({ users }) => {
  ...
  const TableRow = ({ user }) => (
    <tr className='border-b border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:bg-gray-400/10 dark:hover:bg-gray-700/10'>
      <td className='py-2'>
...
const Dashboard = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      total: totals["em andamento"] || 0,
      icon: <LuClipboardEdit />,
      bg: "bg-[#f59e0b]",
    },
    {
      _id: "4",
      label: "PROJETOS EM RECRUTAMENTO",
      total: totals[" recrutando"],
      icon: <FaArrowsToDot />,
      bg: "bg-[#be185d]" || 0,
    },
  ];
    ...
    return (
      <div className='w-full h-32 bg-white dark:bg-gray-800 p-5 shadow-md rounded-md flex items-center justify-between'>
        <div className='h-full flex flex-1 flex-col justify-between'>
          ...
          <span className='text-sm text-gray-400'>{"110 no último mês"}</span>
        </div>
  ...
  return (
    <div className='h-full py-4 dark:bg-gray-700'>
