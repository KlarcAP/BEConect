...
const Trash = () => {
  ...
  const deleteAllClick = () => {
    setType("deleteAll");
    setMsg("Deseja excluir permanentemente todos os itens?");
    setOpenDialog(true);
  };

  const restoreAllClick = () => {
    setType("restoreAll");
    setMsg("Você deseja restaurar todos os itens da lixeira?");
    setOpenDialog(true);
  };
  ...
  const restoreClick = (id) => {
    setSelected(id);
    setType("restore");
    setMsg("Deseja restaurar o item selecionado?");
    setOpenDialog(true);
  };
  ...
  const TableHeader = () => (
    <thead className='border-b border-gray-300'>
      <tr className='text-black dark:text-white  text-left'>
        <th className='py-2'>Título do Projeto</th>
    ...
    <>
      <div className='w-full md:px-1 px-0 mb-6'>
        <div className='flex items-center justify-between mb-8'>
          <Title title='Projetos Excluidos' />
